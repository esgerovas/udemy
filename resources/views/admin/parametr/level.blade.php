                ...
                <tr>{{-- 
                 ...
                 @foreach($data as $level)
                    <tr>
                        ...
                        {{csrf_field()}}
                        {{ method_field('PUT') }}
                          <td><textarea name="name" rows=1; style="width:100%; resize: none; border:0;" required>{{$level->name}}</textarea></td>
                          <td> 
                            <input type="submit" name="submit" class="btn-sm btn-success" value="Yenile" style="border:0;">
                          </td>
                        </form>
                        <td>
                          <a href="{{url('/admin/level/'.$level->id)}}" class="btn-sm btn-danger" style=" display:inline-block;">Sil</a>
                        </td>
                    </tr>
                @endforeach
              </table>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
          <div class="box box-default collapsed-box box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="{{url('/admin/level')}}" method="post"> 
                {{csrf_field()}}
                <div class="form-group">
                  <label>Səviyə adı</label>
