...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Dərslər</span>
        ...
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-th"></i> <span>İstifadəçilər</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-pie-chart"></i>
            <span>Sual və Cavab blogu</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-laptop"></i>
            <span>Dərslər haqqında şərhlər</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Saytın Parametrləri</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ url('/admin/menu') }}"><i class="fa fa-circle-o"></i>Menular</a></li>
            {{-- <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i>Alt Menular</a></li> --}}
            <li><a href="{{ url('/admin/level') }}"><i class="fa fa-circle-o"></i>Dərs səviyyələri</a></li>
            <li><a href="{{url('/admin/language')}}"><i class="fa fa-circle-o"></i>Dərs dilləri</a></li>
          </ul>
        </li>
      </ul>       
    </section>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2016 <a href="#">Udemy_az</a>.</strong> Bütün hüquqlar qorunur...
  </footer>
