...
--
-- Host: localhost
-- Generation Time: Oct 01, 2016 at 09:52 
...
(1, 'Sara Esgerova', 'sara.a@code.edu.az', '$2y$10$pFOyoQqxqDMnL9rhY333Y.JNsSAshrjtrpNCGMbPI4rOegX0eMNnO', 'wdyOStBrSDyTcC384DEhlMUFaC6FVcIJa6UUki8Z18G5inhYRsK43cMsiI82', '2016-09-30 13:12:49', '2016-10-02 01:45:31'),
(2, 'Alim', 'alim.b@code.edu.az', '$2y$10$6h/I0z/ZUcAzIVqHonjco.WFkGOTFKrK0VitroPovHSAQT3Ilaxiy', 'EDYJgnXnLcmfWe7QCgkr2huptUpNTRxogXfXdpjP21qj4IzyFcOVX2CRTI1A', '2016-10-02 01:46:39', '2016-10-02 01:46:54');
...
(4, 'Yakin Kampus', 'Education System', 'Yakın Kampus''ün eğitim videolarıyla geleceğinizi elinize almanıza yardımcı olur\r\n\r\nAyrıca yazılım ve tasarımla ilgili sorularınızı toplulukla paylaşabilir ve başkalarının sorularını cevaplayabilirsiniz', 'sara@code.edu.az', 'https://www.facebook.com/YakinKampus', NULL, 'https://twitter.com/YakinKampus', NULL, 'https://www.yakinkampus.com', '5653386_9a47_3.jpg', '123456', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`, `image`, `last_login_at`, `status`) VALUES
(1, 'Sara Esgerova', 'sara.a@code.edu.az', '$2y$10$d8sp5w3CxJLQH6zSaCHbFeiEuYn/CkIkXrUUROCF.hBEUSPIL58cW', 'zfwEN8S36jIFFE6Kbl2ey214y5YYCbc737q6IfoVIGRkC1kARFg0dl0ROAbt', '2016-10-01 17:36:25', '2016-10-02 02:14:33', 'default.png', '0000-00-00 00:00:00', 0);
